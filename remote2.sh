...
apt -y install  /home/ubuntu/google-chrome-stable_current_amd64.deb /home/ubuntu/chrome-remote-desktop_current_amd64.deb
...
su ubuntu -l -c "gsettings set org.gnome.desktop.screensaver lock-enabled false"
su ubuntu -l -c "gsettings set org.gnome.shell.extensions.dash-to-dock click-action 'minimize'"
